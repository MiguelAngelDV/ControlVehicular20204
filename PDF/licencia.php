...
$pdf->AddPage('P','Legal');
$pdf->SetFont('Arial','',8);
$pdf->Cell(15,15, $pdf->image('qro.png',10,10,-270),0,'R');
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(65,4, $datos['Fechavencimiento'],'',2,'L');
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(30,4,$datos['Fechaexpiracion'],'',0,'L');
...
$pdf->image('face.png',50,28,25);

#Reverso de la licencia

$pdf->Cell(67,15,"",'',1);
$pdf->Cell(13,10,$pdf->image('911.jpg',12,135,10),'');
$pdf->Cell(40,10,"B21125876",'',0);
$pdf->Cell(13,10,$pdf->image('089.jpg',65,135,10),'',1);
$pdf->SetFont('Arial','B',6);
$pdf->Cell(65,4,"Domicilio",'',1,'R');
$pdf->SetFont('Arial','',9);
$pdf->Cell(30,4,'','',0,'R');
// Falta domicilio en la BD
$pdf->MultiCell(35,4, 'Domicilio','');
$pdf->Cell(65,10,'','',2);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(33,4,'Restricciones','',0,'L');
$pdf->Cell(33,4,'Grupo Sanguineo','',1,'R');
$pdf->SetFont('Arial','',9);
$pdf->Cell(33,4,'restriccion','',0,'L');
// Grupo sanguineo en la BD
$pdf->Cell(33,4, $datos['Tipo'],'',1,'R');
$pdf->SetFont('Arial','B',8);
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(66,4,$datos['Numemergencias'],'',1,'R');
$pdf->SetFont('Arial','B',6);
